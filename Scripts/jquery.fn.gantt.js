...
(function ($, undefined) {
    ...
    Date.prototype.getWeekOfYear = function () {
        ...
        return Math.ceil(new Date(year, this.getMonth(), date + diff).getDayOfYear() / 7);
    };
    ...
    $.fn.gantt = function (options) {
        ...
        var settings = {
            ...
            holidays: [],
            // paging
            itemsPerPage: 300, // Michelle 20190521 修改把 7 改成 300
            // localisation
            dow: ["S", "M", "T", "W", "T", "F", "S"],
            months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
            //waitText: "Please wait...", // Michelle 20190522 註解
            // navigation
            navigate: "buttons",
            scrollToToday: true,
            // cookie options
            ...
            // scale parameters
            scale: "months", // Michelle 20190521 修改把 days 改成 months
            maxScale: "months",
            minScale: "hours",
            // callbacks
