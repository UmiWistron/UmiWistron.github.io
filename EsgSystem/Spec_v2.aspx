<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Spec_v2.aspx.cs" Inherits="EsgSystem_Spec_v2" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ESG System SPEC_V2</title>
    <meta charset="UTF-8" />
    ...
    <script>
        ...
        function closeAll() {
            ...
            var div_EsgiSetting = document.getElementById("div_EsgiSetting");
            ...
            var div_Esgi = document.getElementById("div_Esgi");
            var div_DashboardEsgi = document.getElementById("div_DashboardEsgi");
            ...
            div_EsgiSetting.style.display = "none";
            ...
            div_Esgi.style.display = "none";
            div_DashboardEsgi.style.display = "none";
        ...
        function EsgiSetting_Click() {
            closeAll();
            var div_EsgiSetting = document.getElementById("div_EsgiSetting");
            div_EsgiSetting.style.display = "block";
        }

        function Esgi_Click() {
            closeAll();
            var div_Esgi = document.getElementById("div_Esgi");
            div_Esgi.style.display = "block";
        }
        ...
        function DashboardEsgi_Click() {
            closeAll();
            var div_DashboardEsgi = document.getElementById("div_DashboardEsgi");
            div_DashboardEsgi.style.display = "block";
        }
                ...
                var chartData = {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            type: 'line',
                            fill: false,
                            data: [292, 292, 292, 292, 292, 292, 292, 292, 292, 292, 292, 292]
                        }, {
                            label: 'KPI',
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div class="w3-bar w3-top w3-black w3-large" style="z-index: 4">
                ...
                <span class="w3-bar-item w3-right">ESG System SPEC_V2</span>
            </div>
            ...
            <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index: 3; width: 300px;" id="mySidebar">
                ...
                <div class="w3-bar-block">
                    ...
                    <a href="#" class="w3-bar-item w3-button w3-padding" onclick="EsgiSetting_Click()"><i>○</i> ESGI目標設定</a>
                ...
                <div class="w3-bar-block">
                    <a href="#" class="w3-bar-item w3-button w3-padding-16 w3-hide-large w3-dark-grey w3-hover-black" onclick="w3_close()" title="close menu"><i class="fa fa-remove fa-fw"></i>Close Menu</a>
                    <a href="#" class="w3-bar-item w3-button w3-padding" onclick="Esgi_Click()"><i>○</i> ESGI績效填寫</a>
                    <br />
                    <br />
                </div>
                <div class="w3-container">
                ...
                <div class="w3-bar-block">
                    ...
                    <a href="#" class="w3-bar-item w3-button w3-padding" onclick="DashboardEsgi_Click()"><i>○</i> ESGI目標</a>
                    <br />
                    <br />
                </div>
            </nav>
            ...
            <div class="w3-main" style="margin-left: 300px; margin-top: 43px;">
                ...
                <!-- ESGI目標設定 -->
                <div id="div_EsgiSetting">
                    <header class="w3-container" style="padding-top: 22px">
                        <h5><b>◆ ◆ ◆ ESGI目標設定 ◆ ◆ ◆</b></h5>
                        <label>設定ESGI短中長期目標</label>
                        <br />
                        <br />
                        <label class="scenLabel">
                            使用情境:<br />
                    ...
                    <div class="w3-container">
                        <button onclick="document.getElementById('div_add_EsgiYear').style.display='block'; return false;">新增目標年份</button>
                        &nbsp
                        <button onclick="document.getElementById('div_edit_EsgiYear').style.display='block'; return false;">編輯目標年份</button>
                        <br />
                        <br />
                    </div>
                    <div class="w3-container">
                        <br />
                        <br />
                        <span class="scenTitle">績效目標: </span>
                        <br />
                        <br />
                        <button onclick="document.getElementById('div_add_EsgiItem').style.display='block'; return false;">新增績效目標</button>
                        ...
                        <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-white">
                            ...
                            <tr>
                                <td>環境</td>
                                <td>氣候變遷與能源管理</td>
                                <td>改善能源使用效率，提高再生能源使用</td>
                                <td>較2016年溫室氣體絕對減量減少</td>
                                <td>-21%</td>
                                <td>-25.20%</td>
                                <td>-37.80%</td>
                                <td></td>
                                <td>碳中和</td>
                                <td>
                                    <button onclick="document.getElementById('div_set_EsgiYear').style.display='block'; return false;">年度目標設定</button></td>
                            </tr>
                            <tr>
                                <td>環境</td>
                                <td>水管理</td>
                                <td>落實水資源管理與日常節水；實踐水回收與癈污水管理，提高再生能源使用</td>
                                <td>較2016年單位營收用水量（密集度）減少</td>
                                <td>-9%</td>
                                <td>-10%</td>
                                <td>-13%</td>
                                <td></td>
                            ...
                            <tr>
                                <td>公司治理</td>
                                <td>誠信經營</td>
                                <td>落實員工教育訓練，強化行為準則及誠信經營的公司文化</td>
                                <td>員工遵守「道德行為準則」聲明書之簽署率</td>
                                <td>100%</td>
                                <td>100%</td>
                                <td>100%</td>
                                <td></td>
                            ...
                            <tr>
                                <td>創新</td>
                                <td>創新管理</td>
                                <td>擴展涵蓋技術範圍/國別、提升專利品質以及增加整體專利價值</td>
                                <td>發明專利所佔的比率</td>
                                <td>>86%</td>
                                <td>>87%</td>
                                <td>>90%</td>
                                <td></td>
                                <td>電腦/平板/伺服器以外的專利技術(產品)占比 > 50%;<br />
                                    台/中/美以外的專利占比 > 10%</td>
                                <td>
                                    <button onclick="document.getElementById('div_set_EsgiYear').style.display='block'; return false;">年度目標設定</button></td>
                            </tr>
                    ...
                    <!--Esgi設定 編輯目標年度 -->
                    <div id="div_edit_EsgiYear" class="w3-modal">
                        <div class="w3-modal-content">
                            <header class="w3-container w3-light-grey">
                                <span onclick="document.getElementById('div_edit_EsgiYear').style.display='none'"
                                    class="w3-button w3-display-topright">&times;</span>
                                <h5><b>編輯目標年度</b></h5>
                                <label class="specLabel">刪除時將會刪除各績效目標的年度設定!</label><br />
                            </header>
                            <br />
                            <div class="w3-container">
                                <table class="w3-table w3-hoverable w3-white">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label class="radio-inline">
                                                <input type="radio" name="optradio_EsgiYear_1" />Y
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="optradio_EsgiYear_1" />N
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <label class="radio-inline">
                                                <input type="radio" name="optradio_EsgiYear_2" />Y
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="optradio_EsgiYear_2" />N
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <label class="radio-inline">
                                                <input type="radio" name="optradio_EsgiYear_3" />Y
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="optradio_EsgiYear_3" />N
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <label class="radio-inline">
                                                <input type="radio" name="optradio_EsgiYear_4" />Y
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="optradio_EsgiYear_4" />N
                                            </label>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <footer class="w3-container w3-light-grey w3-right-align">
                                <br />
                                <button onclick="document.getElementById('div_edit_EsgiYear').style.display='none'; return false;">Cancel</button>
                                &nbsp&nbsp&nbsp
                                    <button onclick="document.getElementById('div_edit_EsgiYear').style.display='none'; return false;">Confirm</button>
                                <br />
                                <br />
                            </footer>
                        </div>
                    ...
                    <!-- Esgi目標設定 新增年份 -->
                    <div id="div_add_EsgiYear" class="w3-modal">
                        <div class="w3-modal-content">
                            <header class="w3-container w3-light-grey">
                                <span onclick="document.getElementById('div_add_EsgiYear').style.display='none'"
                                    class="w3-button w3-display-topright">&times;</span>
                                <h5><b>新增年份</b></h5>
                            </header>
                            <div class="w3-container">
                            ...
                            <footer class="w3-container w3-light-grey w3-right-align">
                                <br />
                                <button onclick="document.getElementById('div_add_EsgiYear').style.display='none'; return false;">Cancel</button>
                                &nbsp&nbsp&nbsp
                                    <button onclick="document.getElementById('div_add_EsgiYear').style.display='none'; return false;">Confirm</button>
                                <br />
                                <br />
                            </footer>
                        </div>
                    ...
                    <!-- Esgi目標設定 新增績效目標 -->
                    <div id="div_add_EsgiItem" class="w3-modal">
                        <div class="w3-modal-content">
                            <header class="w3-container w3-light-grey">
                                <span onclick="document.getElementById('div_add_EsgiItem').style.display='none'"
                                    class="w3-button w3-display-topright">&times;</span>
                                <h5><b>新增績效目標</b></h5>
                            </header>
                            <div class="w3-container">
                                ...
                                <table class="w3-table w3-hoverable w3-white">
                                    ...
                                    <tr>
                                        <td>編號</td>
                                        <td>
                                            <input type="text" placeholder="No" /></td>
                                    </tr>
                                    <tr>
                                        <td>議題</td>
                                        <td colspan="2">
                                    ...
                                    <tr>
                                        <td>群組</td>
                                        <td colspan="2">
                                            <select name="EsgiGroup">
                                                <option>Green Product</option>
                                                <option>SCM</option>
                                                <option>Decarb</option>
                                                <option>...</option>
                                            </select></td>
                                    </tr>
                                </table>
                            ...
                            <footer class="w3-container w3-light-grey w3-right-align">
                                <br />
                                <button onclick="document.getElementById('div_add_EsgiItem').style.display='none'; return false;">Cancel</button>
                                &nbsp&nbsp&nbsp
                                <button onclick="document.getElementById('div_add_EsgiItem').style.display='none'; return false;">Confirm</button>
                                <br />
                                <br />
                            </footer>
                        </div>
                    ...
                    <!-- Esgi目標設定 年度目標設定 -->
                    <div id="div_set_EsgiYear" class="w3-modal">
                        <div class="w3-modal-content">
                            <header class="w3-container w3-light-grey">
                                <span onclick="document.getElementById('div_set_EsgiYear').style.display='none'"
                                    class="w3-button w3-display-topright">&times;</span>
                                <h5><b>年度目標設定</b></h5>
                            </header>
                            <div class="w3-container">
                            ...
                            <footer class="w3-container w3-light-grey w3-right-align">
                                <br />
                                <button onclick="document.getElementById('div_set_EsgiYear').style.display='none'; return false;">Cancel</button>
                                &nbsp&nbsp&nbsp
                                    <button onclick="document.getElementById('div_set_EsgiYear').style.display='none'; return false;">Confirm</button>
                                <br />
                                <br />
                            </footer>
                        </div>
                ...
                <div id="div_Esgi">
                    ...
                    <div class="w3-container">
                        ...
                        <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-white">
                            ...
                            <tr>
                                ...
                                <td>碳中和</td>
                                <td>
                                    <button onclick="document.getElementById('div_edit_Esgi').style.display='block'; return false;">編輯</button></td>
                            </tr>
                            <tr>
                                <td>環境</td>
                                <td>水管理</td>
                    ...
                    <!-- Esgi目標設定 年度目標設定 -->
                    <div id="div_edit_Esgi" class="w3-modal">
                        <div class="w3-modal-content">
                            <header class="w3-container w3-light-grey">
                                <span onclick="document.getElementById('div_edit_Esgi').style.display='none'"
                                    class="w3-button w3-display-topright">&times;</span>
                                <h5><b>年度目標設定</b></h5>
                            </header>
                            <div class="w3-container">
                            ...
                            <footer class="w3-container w3-light-grey w3-right-align">
                                <br />
                                <button onclick="document.getElementById('div_edit_Esgi').style.display='none'; return false;">Cancel</button>
                                &nbsp&nbsp&nbsp
                                    <button onclick="document.getElementById('div_edit_Esgi').style.display='none'; return false;">Confirm</button>
                                <br />
                                <br />
                            </footer>
                        </div>
                ...
                <!-- Dashboard ESGI -->
                <div id="div_DashboardEsgi">
                    <header class="w3-container" style="padding-top: 22px">
                        <h5><b>◆ ◆ ◆ ESGI目標 ◆ ◆ ◆</b></h5>
                        <label>ESGI短中長期目標</label>
                        <br />
                        <br />
                        <br />
                        <br />
